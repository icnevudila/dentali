...
export function authFormCardClassName() {
  return cn(
    "auth-form-card mx-auto w-full max-w-[400px] space-y-7 rounded-2xl border border-neutral-200/70 bg-white/95 p-6 shadow-[0_8px_40px_-12px_rgba(15,23,42,0.12)] backdrop-blur-sm",
