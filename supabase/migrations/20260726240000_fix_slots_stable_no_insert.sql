-- Fix: get_available_appointment_slots is STABLE (read-only) but was calling
-- ensure_provider_availability_defaults which INSERTs →
-- "cannot execute INSERT in a read-only transaction".
-- Client already seeds via ensureProviderAvailabilityDefaults before this RPC.
